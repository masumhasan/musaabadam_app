...
class StreamService {
  ...
  Future<StreamModel> createStream({
    ...
    String primarySellingFormat = 'auction',
    String repeatOption = 'doesNotRepeat',
  ...
  Future<StreamModel> updateStream(String streamId, {
    ...
    final response = await _dio.patch(ApiConstants.updateStream(streamId), data: {
      ...
      if (videoPreviewUrl != null) 'videoPreviewUrl': videoPreviewUrl,
      if (primarySellingFormat != null) 'primarySellingFormat': primarySellingFormat,
      if (repeatOption != null) 'repeatOption': repeatOption,
      if (shippingSettings != null) 'shippingSettings': shippingSettings,
      if (freePickup != null) 'freePickup': freePickup,
      if (explicitContent != null) 'explicitContent': explicitContent,
